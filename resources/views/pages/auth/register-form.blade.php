...
@section('content')
    ...
    <div class="col-lg-7 p-5">
        <h3 class="text-center mb-4 text-success fw-bold">Buat Akun Baru Anda</h3>
        @if ($errors->any())
        ...
        <form method="POST" action="{{ route('regis.regis') }}">
            ...
            <!-- Tombol diubah menjadi hijau -->
            <button type="submit" class="btn btn-success w-100 mb-3">Daftar Sekarang</button>

            <p class="text-center small mt-3">
                Sudah punya akun? <a href="{{ route('login') }}" class="text-primary fw-bold text-decoration-none">Login
                    di sini</a>
            </p>
        </form>
    </div>
