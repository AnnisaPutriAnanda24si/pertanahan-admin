...
<head>
    ...
    <title>Tabel Jenis Penggunaan</title>
        ...
        <div class="h-19">
            ...
            <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap dark:text-white text-slate-700"
                ...
                <img src="{{ asset('assets-admin') }}/img/logo-ct.png"
                    ...
                    alt="main_logo" />
                <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Tabel Jenis
                    Penggunaan</span>
            </a>
        </div>
            ...
            <ul class="flex flex-col pl-0 mb-0">
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors dark:text-white dark:opacity-80"
                        href="{{ route('jenis_penggunaan.create') }}">
                        <div
                            class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                            <i class="relative top-0 text-sm leading-normal text-blue-500 ni ni-tv-2"></i>
                        </div>
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Tambah Jenis
                            Penggunaan</span>
                    </a>
                </li>
                ...
                <div class="flex-none w-full max-w-full px-3">
                    <div
                        ...
                        <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                            <h6 class="dark:text-white">Tabel Jenis Penggunaan</h6>
                        </div>
                                        ...
                                        @foreach ($jenis_penggunaan as $item)
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <form
                                                        action="{{ route('jenis_penggunaan.destroy', $item->jenis_id) }}"
