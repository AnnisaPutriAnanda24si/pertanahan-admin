                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="status" class="form-select @error('status') is-invalid @enderror">
                            ...
                            <option value="proses" {{ old('status', $sengketa->status) == 'proses' ? 'selected' : '' }}>
                                Proses
                            </option>
                            <option value="mediasi" {{ old('status', $sengketa->status) == 'mediasi' ? 'selected' : '' }}>
                                Mediasi
                            </option>
                            <option value="selesai" {{ old('status', $sengketa->status) == 'selesai' ? 'selected' : '' }}>
                                Selesai
                            </option>
                        </select>
                        @error('status')
